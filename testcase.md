...
test_cases = [ ("Deep learning is", "amazing."), ("Deep learning builds intelligent", "systems."), ("Intelligent systems can learn", "something") print(f"{'Input Text':40s} {'Predicted Word':15s} {'Correct (Y/N)'}") for text, true_word in test_cases: pred_word, result = predict_next_word(text, true_word) print(f"{text:40s} {pred_word:15s} {result}") Output:

Output:<img width="1131" height="110" alt="DL EXP-4 Test case OP" src="https://github.com/user-attachments/assets/c53aa520-64ad-487b-98b4-70908600308e" />
